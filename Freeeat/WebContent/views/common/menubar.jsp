...
<body>
  ...
  <header>
    <div class="inner">
      ...
      <div class="sub-menu">
        <ul class="menu">
          ...
          <li>
            <a href="<%= contextPath %>/views/member/joinEnrollForm.jsp">회원가입</a>
          </li>
        ...
        <li>
          <div class="search">
            <form action="test.do" method="get">
              <input type="text" placeholder="찾고싶은 식당명을 검색해주세요.">
              <span class="material-icons"><a href="#" type="submit">search</a> </span>
            </form>
          </div>
        </li>
    ...
    <div class="badges">
      ...
      <div class="sidebar">
        <h2 id="recentTitle">최근 본 식당 (5) </h2>
        <hr>
        <%for(int i = 0; i<3; i++){%>
          <div id="recentList">
            <div id="recentText">
