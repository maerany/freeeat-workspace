...
public class Review { 
	...
	private ArrayList<Tag> tList = new ArrayList(); // 리뷰 태그를 담을 tagList
	...
	public String toString() {
		return "Review [reviewNo=" + reviewNo + ", memNo=" + memNo + ", placeNo=" + placeNo + ", reviewCount="
				...
				+ ", reviewCreateDate=" + reviewCreateDate + ", reviewDelete=" + reviewDelete + ", nickName=" + nickName
				+ ", profileRevise=" + profileRevise + ", profileSavePath=" + profileSavePath + ", rPhotoList="
				+ rPhotoList + ", tList=" + tList + "]";
	}
